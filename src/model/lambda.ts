import { LambdaParameter } from './lambda-parameter';
...
export class Lambda {
    ...
    constructor(private id : number, private commit: Commit, private file, private startLine: number, private endLine: number,
        ...
        private body: string, private parameters: LambdaParameter[], private status: string, private tags: string[],
        private locationStatus: string, private parent: string, private lambdaString: string) {}
    ...
    public getLambdaString() : string { return this.lambdaString; }
