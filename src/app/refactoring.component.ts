...
export class RefactoringComponent {
  ...
  public sendEmail() {
    this.backendService.sendEmail(this.commit.getAuthor(), this.commit.getAuthorEmail(), this.emailBody, this.emailSubject, this.refactoring.getID(), this.emailMyself)
      .subscribe(
